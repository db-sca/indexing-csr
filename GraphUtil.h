...
class GraphUtil {
	public:
		...
		static void dfs_backwards(Graph& g, int vid, vector<int>& postorder, vector<bool>& visited);
//		static void topological_sort(Graph g, vector<int>& ts);
		static void topological_sort(Graph &g, vector<int>& ts);
		static void topological_sort(Graph &g, vector<int>& re_ts, vector<int> & ts);
		static void topological_sort_backwards(Graph &g, vector<int>& ts);
