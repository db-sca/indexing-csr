...
protected:
	...
	public:
		...
		void setRadius(int);
		vector<string> makeggfilename(const char* filestem); // generated gate graph filename based on radius and preselectratio ***.<radius><preselect*1000>gg
		
		// methods for query
		virtual bool reach(int src, int trg);
